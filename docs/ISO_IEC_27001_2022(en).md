...
> height="0.7604166666666666in"}Reference number ISO/IEC 27001:2022(E)
>
> ![](media/image2.png){width="0.5368602362204724in"
> height="0.470576334208224in"} **COPYRIGHT PROTECTED DOCUMENT**
>
> © ISO/IEC 2022
>
...
>
> Website: [[www.iso.org]{.underline}](https://www.iso.org/)
>
> Published in Switzerland
>
> **Contents** Page
>
> [Foreword](#foreword) [iv](#foreword)
>
> [Introduction](#introduction) [v](#introduction)
...
4.  [Context of the organization](#context-of-the-organization)
    ...
    1.  [Understanding the organization and its
        > context](#understanding-the-organization-and-its-context)
        > [1](#understanding-the-organization-and-its-context)

    2.  [Understanding the needs and expectations of interested
        > parties](#understanding-the-needs-and-expectations-of-interested-parties)
        > [1](#understanding-the-needs-and-expectations-of-interested-parties)

    3.  [Determining the scope of the information security management
        > system](#determining-the-scope-of-the-information-security-management-system)
        > [2](#determining-the-scope-of-the-information-security-management-system)

    4.  [Information security management
        > system](#information-security-management-system)
        > [2](#information-security-management-system)

5.  [Leadership](#leadership) [2](#leadership)

    1.  [Leadership and commitment](#leadership-and-commitment)
        > [2](#leadership-and-commitment)

    2.  [Policy](#policy) [3](#policy)

    3.  [Organizational roles, responsibilities and
        > authorities](#organizational-roles-responsibilities-and-authorities)
        > [3](#organizational-roles-responsibilities-and-authorities)

6.  [Planning](#planning) [3](#planning)

    1.  [Actions to address risks and
        > opportunities](#actions-to-address-risks-and-opportunities)
        > [3](#actions-to-address-risks-and-opportunities)

        1.  [General](#general) [3](#general)

        2.  [Information security risk
            > assessment](#information-security-risk-assessment)
            > [4](#information-security-risk-assessment)

        3.  [Information security risk
            > treatment](#information-security-risk-treatment)
            > [4](#information-security-risk-treatment)

    2.  [Information security objectives and planning to achieve
        > them](#information-security-objectives-and-planning-to-achieve-them)
        > [5](#information-security-objectives-and-planning-to-achieve-them)

7.  [Support](#support) [6](#support)

    1.  [Resources](#resources) [6](#resources)

    2.  [Competence](#competence) [6](#competence)

    3.  [Awareness](#awareness) [6](#awareness)

    4.  [Communication](#communication) [6](#communication)

    5.  [Documented information](#documented-information)
        > [6](#documented-information)

        1.  [General](#general-1) [6](#general-1)

        2.  [Creating and updating](#creating-and-updating)
            > [7](#creating-and-updating)

        3.  [Control of documented
            > information](#control-of-documented-information)
            > [7](#control-of-documented-information)

8.  [Operation](#operation) [7](#operation)

    1.  [Operational planning and
        > control](#operational-planning-and-control)
        > [7](#operational-planning-and-control)

    2.  [Information security risk
        > assessment](#information-security-risk-assessment-1)
        > [8](#information-security-risk-assessment-1)

    3.  [Information security risk
        > treatment](#information-security-risk-treatment-1)
        > [8](#information-security-risk-treatment-1)

9.  [Performance evaluation](#performance-evaluation)
    > [8](#performance-evaluation)

    1.  [Monitoring, measurement, analysis and
        > evaluation](#monitoring-measurement-analysis-and-evaluation)
        > [8](#monitoring-measurement-analysis-and-evaluation)

    2.  [Internal audit](#internal-audit) [8](#internal-audit)

        1.  [General](#general-2) [8](#general-2)

        2.  [Internal audit programme](#internal-audit-programme)
            > [9](#internal-audit-programme)

    3.  [Management review](#management-review) [9](#management-review)

        1.  [General](#general-3) [9](#general-3)

        2.  [Management review inputs](#management-review-inputs)
            > [9](#management-review-inputs)

        3.  [Management review results](#management-review-results)
            > [9](#management-review-results)

10. [Improvement](#improvement) [10](#improvement)

    1.  [Continual improvement](#continual-improvement)
        > [10](#continual-improvement)

    2.  [Nonconformity and corrective
        > action](#nonconformity-and-corrective-action)
        > [10](#nonconformity-and-corrective-action)

> [Annex A (normative) Information security controls
> reference](#_bookmark45) [11](#_bookmark45)
>
> [Bibliography](#_bookmark47) [19](#_bookmark47)
...
> 2 (see
> [[www.iso.org/directives]{.underline}](https://www.iso.org/directives-and-policies.html)
> or
...
> [[https://patents.iec.ch]{.underline}](https://patents.iec.ch/)).
>
...
> *Information Technology*, Subcommittee SC 27, *Information security,
> cybersecurity and privacy protection*.
>
> This third edition cancels and replaces the second edition (ISO/IEC
> 27001:2013), which has been technically revised. It also incorporates
> the Technical Corrigenda ISO/IEC 27001:2013/Cor 1:2014 and ISO/IEC
> 27001:2013/Cor 2:2015.
>
> The main changes are as follows:
>
> --- the text has been aligned with the harmonized structure for
> management system standards and ISO/IEC 27002:2022.
>
...
> This document has been prepared to provide requirements for
> establishing, implementing, maintaining and continually improving an
> information security management system. The adoption of an information
> security management system is a strategic decision for an
> organization. The establishment and implementation of an
...
> organization. All of these influencing factors are expected to change
> over time.
>
...
>
> It is important that the information security management system is
> part of and integrated with the organization's processes and overall
> management structure and that information security is considered in
> the design of processes, information systems, and controls. It is
> expected that an information security management system implementation
> will be scaled in accordance with the needs of the organization.
>
> This document can be used by internal and external parties to assess
> the organization\'s ability to meet the organization's own information
> security requirements.
>
> The order in which requirements are presented in this document does
> not reflect their importance or imply the order in which they are to
> be implemented. The list items are enumerated for reference purpose
> only.
>
...
> 27003\[[[2]{.underline}](#_bookmark49)\], ISO/IEC
> 27004\[[[3]{.underline}](#_bookmark50)\] and ISO/IEC
> 27005\[[[4]{.underline}](#_bookmark51)\]), with related terms and
> definitions.

2.  **Compatibility with other management system standards**

> This document applies the high-level structure, identical sub-clause
> titles, identical text, common terms, and core definitions defined in
> Annex SL of ISO/IEC Directives, Part 1, Consolidated ISO Supplement,
> and therefore maintains compatibility with other management system
> standards that have adopted the Annex SL.
>
> This common approach defined in the Annex SL will be useful for those
> organizations that choose to operate a single management system that
> meets the requirements of two or more management system standards.
>
...
> [[Clauses 4]{.underline}](#context-of-the-organization) to
> [[10]{.underline}](#improvement) is not acceptable when an
> organization claims conformity to this document.
...
-   ISO Online browsing platform: available at
    > [[https://www.iso.org/obp]{.underline}](https://www.iso.org/obp/ui)
...
>
> NOTE Determining these issues refers to establishing the external and
> internal context of the organization considered in Clause 5.4.1 of ISO
> 31000:2018\[[[5]{.underline}](#_bookmark52)\].
...
> NOTE The requirements of interested parties can include legal and
...
a)  the external and internal issues referred to in
    > [[4.1]{.underline}](#understanding-the-organization-and-its-context);

b)  the requirements referred to in
    > [[4.2]{.underline}](#understanding-the-needs-and-expectations-of-interested-parties);
...
> improve an information security management system, including the
...
e)  ensuring that the information security management system achieves
    > its intended outcome(s);

f)  directing and supporting persons to contribute to the effectiveness
...
b)  includes information security objectives (see
    > [[6.2]{.underline}](#information-security-objectives-and-planning-to-achieve-them))
    > or provides the framework for setting information security
    > objectives;
...
d)  includes a commitment to continual improvement of the information
    > security management system. The information security policy shall:
...
a)  ensuring that the information security management system conforms to
    > the requirements of this document;

b)  reporting on the performance of the information security management
    > system to top management.

> NOTE Top management can also assign responsibilities and authorities
> for reporting performance of the information security management
...
d)  analyses the information security risks:
    ...
    1.  assess the potential consequences that would result if the risks
        > identified in
        > [[6.1.2]{.underline}](#information-security-risk-assessment) c)
        > 1) were to
...
e)  evaluates the information security risks:
    ...
    1.  compare the results of risk analysis with the risk criteria
        > established in
        > [[6.1.2]{.underline}](#information-security-risk-assessment)
        > a); and
...
> NOTE 1 Organizations can design controls as required, or identify them
> from any source.

c)  compare the controls determined in
    > [[6.1.3]{.underline}](#information-security-risk-treatment) b)
    > above with those in [[Annex A]{.underline}](#_bookmark45) and
    > verify that no necessary controls have been omitted;

> NOTE 2 [[Annex A]{.underline}](#_bookmark45) contains a list of
> possible information security controls. Users of this document are
>
> directed to [[Annex A]{.underline}](#_bookmark45) to ensure that no
> necessary information security controls are overlooked.
>
> NOTE 3 The information security controls listed in [[Annex
> A]{.underline}](#_bookmark45) are not exhaustive and additional
> information security controls can be included if needed.

d)  produce a Statement of Applicability that contains:

    -   the necessary controls (see
        > [[6.1.3]{.underline}](#information-security-risk-treatment) b)
        > and c));
    ...
    -   the justification for excluding any of the [[Annex
        > A]{.underline}](#_bookmark45) controls.
...
> process.
>
> NOTE 4 The information security risk assessment and treatment process
> in this document aligns with the principles and generic guidelines
> provided in ISO 31000\[[[5]{.underline}](#_bookmark52)\].

### Information security objectives and planning to achieve them

> The organization shall establish information security objectives at
> relevant functions and levels. The information security objectives
> shall:
...
> information security objectives, the organization shall determine:
...
l)  how the results will be evaluated.
    ...
    1.  **Planning of changes**

> When the organization determines the need for changes to the
> information security management system, the changes shall be carried
...
> training to, the mentoring of, or the re- assignment of current
> employees; or the hiring or contracting of competent persons.
...
b)  their contribution to the effectiveness of the information security
    > management system, including the benefits of improved information
...
> The organization's information security management system shall
> include:

a)  documented information required by this document; and

b)  documented information determined by the organization as being
    > necessary for the effectiveness of the information security
    > management system.
...
1)  the size of organization and its type of activities, processes,
...
> information security management system, shall be identified as
...
> and change the documented information, etc.
...
> Documented information shall be available to the extent necessary to
...
> occur, taking account of the criteria established in
> [[6.1.2]{.underline}](#information-security-risk-assessment) a).
>
> The organization shall retain documented information of the results of
> the information security risk assessments.

### Information security risk treatment

> The organization shall implement the information security risk
> treatment plan.
>
> The organization shall retain documented information of the results of
...
b)  the methods for monitoring, measurement, analysis and evaluation, as
    > applicable, to ensure valid results. The methods selected should
    > produce comparable and reproducible results to be considered
    > valid;
...
a)  conforms to
    ...
    1.  the organization's own requirements for its information security
        > management system;
...
> The organization shall plan, establish, implement and maintain an
> audit programme(s), including the frequency, methods,
> responsibilities, planning requirements and reporting.
>
> When establishing the internal audit programme(s), the organization
> shall consider the importance of the processes concerned and the
...
b)  select auditors and conduct audits that ensure objectivity and the
...
> implementation of the audit programme(s) and the audit results.
...
d)  feedback on the information security performance, including trends
    > in:
...
g)  opportunities for continual improvement.
    ...
    1.  #### Management review results

> The results of the management review shall include decisions related
> to continual improvement opportunities and any needs for changes to
...
e)  make changes to the information security management system, if
    ...
    > of the nonconformities encountered. Documented information shall
    > be available as evidence of:
...
>
> The information security controls listed in [[Table
> A.1]{.underline}](#_bookmark46) are directly derived from and
> align[]{#_bookmark45 .anchor}ed with those
>
> listed in ISO/IEC 27002:2022\[[[1]{.underline}](#_bookmark48)\],
> Clauses 5 to 8, and shall be used in context with
> [[6.1.3]{.underline}](#information-security-risk-treatment).
>
> **Table A.1 --- Information s**[]{#_bookmark46 .anchor}**ecurity
> controls**
...
|         | > secu- rity               |                            |
|         |                            | Information security       |
|         |                            | policy and topic-specific  |
|         |                            | policies shall be de-      |
|         |                            | fined, approved by         |
|         |                            | management, published,     |
|         |                            | communicated to and        |
|         |                            | acknowledged by relevant   |
...
+---------+----------------------------+----------------------------+
| > 5.2   | > Information security     | **Control**                |
|         | > roles and                |                            |
|         | >                          | Information security roles |
|         | > responsibilities         | and responsibilities shall |
...
|         |                            | all personnel to apply     |
|         |                            | information security in    |
|         |                            | accordance with the        |
|         |                            | established information    |
|         |                            | security policy, top-      |
|         |                            | ic-specific policies and   |
|         |                            | procedures of the          |
|         |                            | organization.              |
+---------+----------------------------+----------------------------+
...
|         |                            | authorities.               |
+---------+----------------------------+----------------------------+
| > 5.6   | > Contact with special     | **Control**                |
|         | > interest                 |                            |
|         | >                          | The organization shall     |
...
|         |                            | information security       |
|         |                            | threats shall be collected |
|         |                            | and analysed to produce    |
|         |                            | threat intelligence.       |
+---------+----------------------------+----------------------------+
| > 5.8   | > Information security in  | **Control**                |
|         | > project management       |                            |
|         |                            | Information security shall |
|         |                            | be integrated into project |
|         |                            | management.                |
+---------+----------------------------+----------------------------+
| > 5.9   | > Inventory of information | **Control**                |
|         | > and other associated     |                            |
|         | > assets                   | An inventory of            |
|         |                            | information and other      |
|         |                            | associated assets,         |
|         |                            | including owners, shall be |
|         |                            | developed and maintained.  |
+---------+----------------------------+----------------------------+
| > 5.10  | > Acceptable use of        | **Control**                |
|         | > information and other    |                            |
|         | > associated assets        | Rules for the acceptable   |
...
|         |                            | appropriate shall return   |
|         |                            | all the organization's     |
|         |                            | assets in their possession |
|         |                            | upon change or termination |
|         |                            | of their employment,       |
...
+--------+-----------------------------+-----------------------------+
| > 5.12 | > Classification of         | **Control**                 |
|        | > information               |                             |
...
|        |                             |                             |
|        |                             | Rules to control physical   |
|        |                             | and logical access to       |
|        |                             | information and other       |
|        |                             | associated assets shall be  |
|        |                             | established and implemented |
|        |                             | based on busi- ness and     |
|        |                             | information security        |
|        |                             | requirements.               |
+--------+-----------------------------+-----------------------------+
...
|        |                             | managed.                    |
+--------+-----------------------------+-----------------------------+
| > 5.17 | > Authentication            | **Control**                 |
|        | > information               |                             |
|        |                             | Allocation and management   |
|        |                             | of authentication           |
|        |                             | information shall be        |
|        |                             | controlled by a management  |
|        |                             | process, including advising |
...
|        |                             | information and other       |
|        |                             | associated assets shall be  |
|        |                             | provisioned, reviewed,      |
|        |                             | modified and removed in     |
|        |                             | accordance with the         |
|        |                             | organization's              |
...
|        |                             | control.                    |
+--------+-----------------------------+-----------------------------+
| > 5.19 | > Information security in   | **Control**                 |
...
|        |                             | with each supplier based on |
|        |                             | the type of supplier        |
|        |                             | relationship.               |
+--------+-----------------------------+-----------------------------+
| > 5.21 | > Managing information      | **Control**                 |
|        | > security in the           |                             |
|        | > information and commu-    | Processes and procedures    |
|        | > nication technology (ICT) | shall be defined and        |
|        | > supply chain              | implemented to manage the   |
|        |                             | information security risks  |
|        |                             | associated with the ICT     |
|        |                             | products and services       |
|        |                             | supply chain.               |
+--------+-----------------------------+-----------------------------+
| > 5.22 | > Monitoring, review and    | **Control**                 |
|        | > change management of      |                             |
|        | > supplier services         | The organization shall      |
...
|        |                             | service delivery.           |
+--------+-----------------------------+-----------------------------+
| > 5.23 | > Information security for  | **Control**                 |
|        | > use of                    |                             |
|        | >                           | Processes for acquisition,  |
|        | > cloud services            | use, management and exit    |
|        |                             | from cloud services shall   |
|        |                             | be established in           |
|        |                             | accordance with the         |
|        |                             | organization's information  |
|        |                             | security requirements.      |
+--------+-----------------------------+-----------------------------+
| > 5.24 | > Information security      | **Control**                 |
|        | > incident management       |                             |
|        | > planning and prepa-       | The organization shall plan |
|        | > ration                    | and prepare for managing    |
|        |                             | information secu- rity      |
|        |                             | incidents by defining,      |
|        |                             | establishing and            |
...
+--------+-----------------------------+-----------------------------+
| > 5.25 | > Assessment and decision   | **Control**                 |
|        | > on in- formation security |                             |
|        | > events                    | The organization shall      |
|        |                             | assess information security |
|        |                             | events and decide if they   |
|        |                             | are to be categorized as    |
|        |                             | information security        |
|        |                             | incidents.                  |
+========+=============================+=============================+
| > 5.26 | > Response to information   | **Control**                 |
|        | > security                  |                             |
|        | >                           | Information security        |
|        | > incidents                 | incidents shall be          |
...
|        |                             | procedures for the iden-    |
|        |                             | tification, collection,     |
|        |                             | acquisition and             |
...
|        | > disruption                | how to maintain information |
|        |                             | security at an appropriate  |
|        |                             | level during disruption.    |
+--------+-----------------------------+-----------------------------+
| > 5.30 | > ICT readiness for         | **Control**                 |
|        | > business con- tinuity     |                             |
|        |                             | ICT readiness shall be      |
|        |                             | planned, implemented,       |
|        |                             | maintained and tested based |
|        |                             | on business continuity      |
|        |                             | objectives and ICT          |
|        |                             | continuity requirements.    |
+--------+-----------------------------+-----------------------------+
| > 5.31 | > Legal, statutory,         | **Control**                 |
|        | > regulatory and            |                             |
...
|        |                             | date.                       |
+--------+-----------------------------+-----------------------------+
| > 5.32 | > Intellectual property     | **Control**                 |
|        | > rights                    |                             |
|        |                             | The organization shall      |
...
+--------+-----------------------------+-----------------------------+
| > 5.34 | > Privacy and protection of | **Control**                 |
|        | > person- al identifiable   |                             |
|        | > information (PII)         | The organization shall      |
|        |                             | identify and meet the       |
|        |                             | requirements regarding the  |
|        |                             | preservation of privacy and |
|        |                             | protection of PII according |
|        |                             | to applicable laws and      |
|        |                             | regulations and contractual |
|        |                             | requirements.               |
+--------+-----------------------------+-----------------------------+
| > 5.35 | > Independent review of     | **Control**                 |
...
|        |                             | significant changes occur.  |
+--------+-----------------------------+-----------------------------+
| > 5.36 | > Compliance with policies, | **Control**                 |
|        | > rules and standards for   |                             |
|        | > information security      | Compliance with the         |
|        |                             | organization's information  |
|        |                             | security policy, top-       |
|        |                             | ic-specific policies, rules |
|        |                             | and standards shall be      |
|        |                             | regularly reviewed.         |
+--------+-----------------------------+-----------------------------+
| > 5.37 | > Documented operating      | **Control**                 |
|        | > proce- dures              |                             |
...
+---------+----------------------------+----------------------------+
| > 6.2   | > Terms and conditions of  | **Control**                |
|         | > em- ployment             |                            |
|         |                            | The employment contractual |
|         |                            | agreements shall state the |
|         |                            | personnel's and the        |
|         |                            | organization's             |
|         |                            | responsibilities for       |
|         |                            | information security.      |
+---------+----------------------------+----------------------------+
| > 6.3   | > Information security     | **Control**                |
...
|         |                            | as relevant for their job  |
|         |                            | function.                  |
+---------+----------------------------+----------------------------+
| > 6.4   | > Disciplinary process     | **Control**                |
|         |                            |                            |
|         |                            | A disciplinary process     |
|         |                            | shall be formalized and    |
|         |                            | communicated to take       |
...
|         |                            | change of employment shall |
|         |                            | be defined, enforced and   |
|         |                            | communicated to relevant   |
|         |                            | personnel and other        |
|         |                            | interested parties.        |
+---------+----------------------------+----------------------------+
| > 6.6   | > Confidentiality or       | **Control**                |
|         | > non-disclosure           |                            |
|         | > agreements               | Confidentiality or         |
|         |                            | non-disclosure agreements  |
|         |                            | reflecting the organ-      |
|         |                            | ization's needs for the    |
...
|         |                            | implemented when personnel |
|         |                            | are working remotely to    |
|         |                            | protect information        |
|         |                            | accessed, processed or     |
|         |                            | stored outside the         |
|         |                            | organization's premises.   |
+---------+----------------------------+----------------------------+
| > 6.8   | > Information security     | **Control**                |
|         | > event re- porting        |                            |
|         |                            | The organization shall     |
...
|         |                            | entry controls and access  |
|         |                            | points.                    |
+---------+----------------------------+----------------------------+
| > 7.3   | > Securing offices, rooms  | **Control**                |
|         | > and fa- cilities         |                            |
...
+---------+----------------------------+----------------------------+
| > 7.5   | > Protecting against       | **Control**                |
|         | > physical and             |                            |
|         | > environmental threats    | Protection against         |
|         |                            | physical and environmental |
|         |                            | threats, such as natural   |
|         |                            | disasters and other        |
|         |                            | intentional or             |
...
|         |                            | implemented.               |
+---------+----------------------------+----------------------------+
| > 7.7   | > Clear desk and clear     | **Control**                |
|         | > screen                   |                            |
|         |                            | Clear desk rules for       |
|         |                            | papers and removable       |
|         |                            | storage media and clear    |
|         |                            | screen rules for           |
|         |                            | information processing     |
|         |                            | facilities shall be        |
...
|         |                            | enforced.                  |
+---------+----------------------------+----------------------------+
| > 7.8   | > Equipment siting and     | **Control**                |
|         | > protection               |                            |
|         |                            | Equipment shall be sited   |
|         |                            | securely and protected.    |
+---------+----------------------------+----------------------------+
| > 7.9   | > Security of assets       | **Control**                |
|         | > off-premises             |                            |
|         |                            | Off-site assets shall be   |
|         |                            | protected.                 |
+---------+----------------------------+----------------------------+
| > 7.10  | > Storage media            | **Control**                |
|         |                            |                            |
|         |                            | Storage media shall be     |
|         |                            | managed through their life |
|         |                            | cycle of acquisition, use, |
|         |                            | transportation and         |
...
|         |                            | information.               |
+---------+----------------------------+----------------------------+
| > 7.14  | > Secure disposal or       | **Control**                |
|         | > re-use of equipment      |                            |
|         |                            | Items of equipment         |
|         |                            | containing storage media   |
|         |                            | shall be verified to en-   |
|         |                            | sure that any sensitive    |
|         |                            | data and licensed software |
|         |                            | has been removed or        |
...
|         |                            | processed by or accessible |
|         |                            | via user end point devices |
|         |                            | shall be protected.        |
+---------+----------------------------+----------------------------+
...
|         |                            | managed.                   |
+---------+----------------------------+----------------------------+
| > 8.3   | > Information access       | **Control**                |
|         | > restriction              |                            |
|         |                            | Access to information and  |
|         |                            | other associated assets    |
|         |                            | shall be restricted in     |
|         |                            | accordance with the        |
|         |                            | established topic-specific |
...
|        |                             | in line with current and    |
|        |                             | expected capacity           |
|        |                             | requirements.               |
+--------+-----------------------------+-----------------------------+
| > 8.7  | > Protection against        | **Control**                 |
|        | > malware                   |                             |
...
|        |                             | user awareness.             |
+--------+-----------------------------+-----------------------------+
| > 8.8  | > Management of technical   | **Control**                 |
|        | > vul- nerabilities         |                             |
...
|        |                             | hardware, software,         |
|        |                             | services and networks shall |
|        |                             | be established, documented, |
...
|        |                             |                             |
|        |                             | Data masking shall be used  |
|        |                             | in accordance with the      |
|        |                             | organization's              |
|        |                             | topic-specific policy on    |
|        |                             | access control and other    |
|        |                             | related topic-specific      |
...
|        |                             | and regularly tested in     |
|        |                             | accordance with the agreed  |
|        |                             | topic-specific policy on    |
|        |                             | backup.                     |
+--------+-----------------------------+-----------------------------+
| > 8.14 | > Redundancy of information | **Control**                 |
...
|        |                             | faults and other relevant   |
|        |                             | events shall be produced,   |
...
|        |                             |                             |
|        |                             | Rules for the effective use |
|        |                             | of cryptography, including  |
|        |                             | cryptographic key           |
|        |                             | management, shall be        |
|        |                             | defined and implemented.    |
+--------+-----------------------------+-----------------------------+
| > 8.25 | > Secure development life   | **Control**                 |
|        | > cycle                     |                             |
|        |                             | Rules for the secure        |
...
|        |                             | approved when developing or |
|        |                             | acquiring applications.     |
+--------+-----------------------------+-----------------------------+
| > 8.27 | > Secure system             | **Control**                 |
|        | > architecture and          |                             |
|        | >                           | Principles for engineering  |
|        | > engineering principles    | secure systems shall be     |
|        |                             | established, docu- mented,  |
|        |                             | maintained and applied to   |
...
+--------+-----------------------------+-----------------------------+
| > 8.29 | > Security testing in       | **Control**                 |
|        | > development and           |                             |
|        | > acceptance                | Security testing processes  |
|        |                             | shall be defined and        |
|        |                             | implemented in the          |
...
|        |                             |                             |
|        |                             | The organization shall      |
|        |                             | direct, monitor and review  |
|        |                             | the activities related to   |
|        |                             | outsourced system           |
|        |                             | development.                |
+--------+-----------------------------+-----------------------------+
| > 8.31 | > Separation of             | **Control**                 |
|        | > development, test and     |                             |
|        | > production environments   | Development, testing and    |
...
+--------+-----------------------------+-----------------------------+
| > 8.34 | > Protection of information | **Control**                 |
|        | > sys- tems during audit    |                             |
|        | > testing                   | Audit tests and other       |
|        |                             | assurance activities        |
|        |                             | involving assessment of op- |
|        |                             | erational systems shall be  |
|        |                             | planned and agreed between  |
|        |                             | the tester and appropriate  |
|        |                             | management.                 |
+--------+-----------------------------+-----------------------------+
...
1.  []{#_bookmark48 .anchor}ISO/IEC 27002:2022, *Information security,
    > cybersecurity and privacy prote*[]{#_bookmark47 .anchor}*ction ---
    > Information security controls*

2.  []{#_bookmark49 .anchor}ISO/IEC 27003, *Information technology ---
    > Security techniques --- Information security management systems
    > --- Guidance*

3.  []{#_bookmark50 .anchor}ISO/IEC 27004, *Information technology ---
    > Security techniques --- Information security management*

> *--- Monitoring, measurement, analysis and evaluation*

4.  []{#_bookmark51 .anchor}ISO/IEC 27005, *Information security,
    > cybersecurity and privacy protection --- Guidance on managing
    > information security risks*

5.  []{#_bookmark52 .anchor}ISO 31000:2018, *Risk management ---
    > Guidelines*
